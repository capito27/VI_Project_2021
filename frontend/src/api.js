...
export default new class {
    ...
    async getViews(full = false, genres = {}, period = {from: 0, to: Number.MAX_SAFE_INTEGER}, queries = null) {
    ...
    async getRatings(full = false, genres = {}, period = {from: 0, to: Number.MAX_SAFE_INTEGER}, queries = null) {
